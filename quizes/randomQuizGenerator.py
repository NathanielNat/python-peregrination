"""Create quiz with questions and answers in random order along with the answer key."""
...
for quizNum in range(40):
    ...
    # writing out header for the quiz
    quizFile.write('Name:\n\nDate:\n\nClass')
    ...
    ##looping through all 50 states to make a question for each
